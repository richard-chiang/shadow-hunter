...
* `git clone git@github.com:rumblex/angularattack2016-perturbed-penguin.git`

* `cd angularattack2016-perturbed-penguin`
...
If you receive an error message `"You do not have permission to publish to perturbed-penguin.2016.angularattack.io"`, it might mean another team member has already deployed your project to Surge. Ask them to run the next step to give you access.

### Step 3) Add Your Team Members to Surge

* `surge . --add mhofer180993@gmail.com`
